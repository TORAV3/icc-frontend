function loadPeduliSesamaDetailData() {
  axios
    ...
    .then((res) => {
      ...
      $$("norek").setValue(res.data.data.norek);
  ...
  elements: [
    {
      margin: 10,
      rows: [
        { type: "section", template: "Data Peduli Sesama" },
        {
          id: "formres",
          margin: 10,
          rows: [
                  ...
                  rows: [
                    {
                      ...
                      minWidth: 100,
                      options: [
                        { id: "Bencana", value: "Bencana" },
                        { id: "Sosial", value: "Sosial" },
                        { id: "Pendidikan", value: "Pendidikan" },
                        { id: "Kesehatan", value: "Kesehatan" },
                      ],
                    },
                  ],
                },
    ...
    },
    {
      ...
      cols: [
        {},
        {
          ...
          autowidth: true,
          click: function () {
            window.location.href = "/manajemen/pedulisesama";
          },
        },
        {
          view: "button",
...
function submit_form() {
  ...
  axios
    .put(`http://localhost:3000/api/icc/pedulisesama/edit/${id}`, formData, {
      headers: {
        Authorization: "Bearer " + token,
      },
    })
